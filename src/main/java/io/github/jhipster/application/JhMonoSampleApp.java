...
public class JhMonoSampleApp {

    private static final Logger log = LoggerFactory.getLogger(JhMonoSampleApp.class);

    private final Environment env;

    public JhMonoSampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhMonoSample.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhMonoSampleApp.class);
